...
Public Class DBAccesser
    ...
    Private Shared _accesser As DBAccesser = New DBAccesser()
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function getInstance() As DBAccesser
        Return _accesser
    End Function
    ...
    Public Function getUpdatableDataTable(ByVal sql As String, ByVal tableName As String) As DataTable
        ...
        If Not _adapterDict.ContainsKey(tableName) Then
    ...
    Public Sub updateDataTable(ByVal dt As DataTable, ByVal tableName As String)
        ...
        'Dim builder As New OleDbCommandBuilder(_adapterDict.Item(tableName))
        'OCommand = builder.GetUpdateCommand()
        '_adapterDict.Item(tableName).UpdateCommand = OCommand
